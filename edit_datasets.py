import pandas as pd
from neural_net_experiment import find_columns_to_check
...
def convert_str_cat_columns_to_numeric(df, cols_to_convert_randomly, cols_to_convert_orderly, save_path, order_map_dict,
...
if __name__ == "__main__":
    ...
    data = pd.read_csv('./datasets/video_games_sales.csv')
    convert_str_cat_columns_to_numeric(data, columns_to_convert_randomly, columns_to_convert_orderly,'./datasets/video_games_sales_converted.csv', order_map)
    print("")
